...
class HelpDesk extends CRMEntity {
    ...
    // danzi.tn@20140909 per selezionare i campi da visualizzare nelle related list bisogna inserire in $list_fields e $list_fields_name i campi corrispondenti, con i valori congrui a quanto presente nella tabella vtiger_field (where tabid=13 per HelpDesk)
    // la chiave degli array deve essere il field label (es 'Datum'), il valore è tablename=>fieldname per $list_fields e solo fieldname per $list_fields_name
	var $list_fields = Array(
					...
					'Datum'=>Array('ticketcf'=>'cf_649'),
					'Hours'=>Array('troubletickets'=>'hours'),
                    'Da fatturare?'=>Array('ticketcf'=>'cf_640'),
                    'Gi&agrave; fatturato'=>Array('ticketcf'=>'cf_641'),
